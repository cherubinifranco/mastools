...
export default function SideMenu() {
  return (
    <div
      ...
      className="fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-hidden -translate-x-[220px] focus-within:translate-x-0 group-active:translate-x-0 transition-transform hover:translate-x-0 bg-sidemenu hover:overflow-y-auto border-r-0"
      tabIndex="-1"
